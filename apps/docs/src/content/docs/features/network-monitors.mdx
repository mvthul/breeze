...
Network Monitors are managed from **Fleet Management → Network Monitor** in the sidebar (`/monitoring`; the entry was called **Monitoring** before v0.114.0), under the **Network Checks** tab.
